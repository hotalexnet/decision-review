...
description: |
  Audit a decision instead of making it: premise challenge, provenance checks, graded evidence, falsifiable criteria. Use for platform, vendor and framework selection, architecture, build-vs-buy, process changes, pricing, and taking on or turning down a client. Triggers on "should we replace X?", "is this judgement backed by anything?", "review this decision", "help me think through whether". Not for product or market validation.
---
